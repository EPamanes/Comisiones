...
{
    public partial class TravelUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if ((Session["scco_user"].ToString() == "" || Session["scco_user"].ToString() == null) || Session["scco_tipo"].ToString() != "Usuario")
        ...
        private void BlockUpdateFields()
        {
            txtHoraInMod.Enabled = false;
            txtDateInMod.Enabled = false;
            txtKilInMod.Enabled = false;
        }
