<%@ Page Title="Viajes Administrador" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TravelAdmin.aspx.cs" Inherits="Calculo_Comisiones_Operadores.TravelAdmin" %>
                            ...
                            <div class="table-responsive">
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-12">
                                            <asp:Label runat="server" CssClass="col-sm-4 control-label" Font-Bold="true" Style="text-align: right;">Operador:</asp:Label>
                                            <asp:DropDownList runat="server" ID="listOperadorMod" CssClass="dropbtn" Font-Bold="true"></asp:DropDownList>
                                        </div>

                                        <div class="form-group col-lg-12">
                                            <asp:Label runat="server" CssClass="col-sm-4 control-label" Font-Bold="true" Style="text-align: right;">Unidad:</asp:Label>
                                            <asp:DropDownList runat="server" ID="listUnidadMod" CssClass="dropbtn" Font-Bold="true"></asp:DropDownList>
                                        </div>

                                        <div class="form-group col-lg-12">
                                            <asp:Label runat="server" CssClass="col-sm-4 control-label" Font-Bold="true" Style="text-align: right;">Fecha de Salida:</asp:Label>
                                            <asp:TextBox ID="txtDateOutMod" runat="server" CssClass="col-sm-4 form-control" Style="text-align: center; width: 150px;" Font-Bold="true" TextMode="Date"></asp:TextBox>&nbsp&nbsp
                                            <asp:TextBox ID="txtHoraOutMod" runat="server" CssClass="col-sm-4 form-control" Style="text-align: center; width: 129px;" Font-Bold="true" MaximumValue="23:59:59" MinimumValue="00:00:00"></asp:TextBox>
                                        ...
                                        <div class="form-group col-lg-12">
                                            <asp:Label runat="server" CssClass="col-sm-4 control-label" Font-Bold="true" Style="text-align: right;">Kilometraje de Salida:</asp:Label>
                                            <asp:TextBox ID="txtKilOutMod" runat="server" CssClass="col-sm-8 form-control" Style="text-align: center" Font-Bold="true" TextMode="Number"></asp:TextBox>
                                        </div>
                                        ...
                                        <br />
                                        <div class="GridviewDiv col-lg-12" align="center">
                                            <asp:GridView runat="server" ID="dgvDetailMod" ShowFooter="false" AllowPaging="false" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true">
                                                <HeaderStyle CssClass="headerstyle" />
                                                <Columns>
                                                    <%--<asp:BoundField DataField="rowid" HeaderText="ID" ReadOnly="true" /> --%>
